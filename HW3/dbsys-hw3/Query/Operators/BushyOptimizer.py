...
#Two main differences from left deep optimizer:
#When picking join order, it considers switching the order of the plans as well
# When searching the initial plan tree to find table scans, it fully explores left and right children
